...
export default function ContentPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    author: "hermes" as ContentItem['author'],
    targetSite: "",
    targetPath: "",
    projectId: "",
  })
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFormData({ title: "", body: "", type: "article", status: "draft", author: "hermes", targetSite: "", targetPath: "", projectId: "" })
    } catch (error) {
  ...
  const getAuthorColor = (author: string) => {
    switch (author) {
      ...
      case 'hermes': return 'bg-amber-100 text-amber-800 dark:bg-amber-900/20 dark:text-amber-200'
      ...
      case 'workspace': return 'bg-pink-100 text-pink-800 dark:bg-pink-900/20 dark:text-pink-200'
      default: return 'bg-gray-100 text-gray-800 dark:bg-gray-900/20 dark:text-gray-200'
    }
  }
