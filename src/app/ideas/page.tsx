...
export default function IdeasPage() {
  ...
  const handleProjectSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Optionally mark idea as converted
      if (confirm("Project aangemaakt! Wil je het idee markeren als omgezet?")) {
        // We could add a 'converted' status to ideas in the future
        // For now, just close the dialog
      }

      alert("✅ Idee succesvol omgezet naar project!")
      setIsProjectDialogOpen(false)
      setProjectFormData({ name: "", status: "planned", category: "tool", description: "" })
    } catch (error) {
      console.error('Failed to convert idea to project:', error)
      alert("❌ Fout bij omzetten naar project")
    }
  }
      ...
      <div className="mx-auto max-w-6xl px-4 py-6 md:px-6">
        <header className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <Dialog open={isProjectDialogOpen} onOpenChange={setIsProjectDialogOpen}>
            <DialogContent>
              <DialogHeader>
                <DialogTitle>Idee omzetten naar project</DialogTitle>
                <DialogDescription>
                  Maak een nieuw project aan gebaseerd op dit idee
                </DialogDescription>
              </DialogHeader>
              <form onSubmit={handleProjectSubmit} className="space-y-4">
                <div>
                  <label htmlFor="project-name" className="text-sm font-medium">Projectnaam</label>
                  <Input
                    id="project-name"
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label htmlFor="project-category" className="text-sm font-medium">Categorie</label>
                    <select
                      id="project-category"
                ...
                <div>
                  <label htmlFor="project-description" className="text-sm font-medium">Beschrijving</label>
                  <Textarea
            ...
            <div className="flex flex-col gap-2 sm:flex-row">
              <Tabs value={selectedCategory} onValueChange={setSelectedCategory}>
                <TabsList className="flex flex-wrap gap-1 h-auto">
                  ...
                  <TabsTrigger value="leadgen" className="text-xs">Leadgen</TabsTrigger>
                  ...
                  <TabsTrigger value="feature" className="text-xs">Feature</TabsTrigger>
                </TabsList>
              </Tabs>
