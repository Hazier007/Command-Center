...
import { Plus, Edit, Trash2, DollarSign, Users, ChevronDown, ChevronRight, ExternalLink } from "lucide-react"
...
import { projectsStorage, tasksStorage, type Project, type Task } from "@/lib/storage"
              ...
              <Card key={project.id}>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <Link href={`/projects/${project.id}`}>
                          <CardTitle className="text-base hover:text-[#F5911E] transition-colors cursor-pointer">{project.name}</CardTitle>
                        </Link>
                ...
                <CardContent className="pt-0">
                  <div className="space-y-3">
                    ...
                    {/* Task count and expand button */}
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-1 text-sm text-muted-foreground">
                        <Users className="h-4 w-4" />
                        <span>{getProjectTaskCount(project.id)} taken</span>
                      </div>
                    ...
                    {expandedProject === project.id && getProjectTasks(project.id).length > 0 && (
                        ...
                        <div className="space-y-2">
                          {getProjectTasks(project.id).map((task) => (
                            <div key={task.id} className="flex items-center justify-between p-2 rounded bg-gray-50 dark:bg-gray-800/50">
                              ...
                              <Badge className={getTaskStatusColor(task.status)} style={{ fontSize: '10px' }}>
                                {task.status}
                              </Badge>
                            </div>
                          ))}
