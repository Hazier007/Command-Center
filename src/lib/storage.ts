...
export interface Task {
  ...
  priority?: 'low' | 'medium' | 'high';
  assignee?: string; // Team BC: 'bart' | 'hermes' | 'wout' (+ oud: 'atlas' | 'forge' | 'ink' | 'ledger' | 'spark' | 'workspace')
  dueDate?: string;
...
export interface ContentItem {
  ...
  author: string // Team BC: 'bart' | 'hermes' | 'wout' (+ oud agents)
...
export interface ActivityItem {
  ...
  actor: string // Team BC: 'bart' | 'hermes' | 'wout' | 'system' (+ oud agents)
  title: string
  description?: string
